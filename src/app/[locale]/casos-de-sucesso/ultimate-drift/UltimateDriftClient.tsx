    ...
    <>
      <div className="px-4 xl:px-0 max-w-5xl mx-auto relative isolate">
        ...
        <section className="py-12 md:py-20 max-w-3xl mx-auto">
          ...
          <p
            className="mt-6 text-base md:text-lg text-foreground/70 max-w-2xl leading-relaxed"
          ...
          {/* SEÇÕES DE TEXTO (PLATFORM, TECH, RESULT) */}
          ...
          <div className="mt-20 space-y-10">
            <div className="text-center space-y-4">
              ...
              <Link href="https://wa.me/5511916329680" target="_blank" rel="noopener noreferrer">
